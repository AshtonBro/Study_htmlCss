...
<body>
    <!--Yandex map sendbox-->
    <script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;apikey=2640f456-537d-4813-9aa9-a6cf13a7dd91"></script>
    <!-- Yandex.Metrika counter --> <script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://cdn.jsdelivr.net/npm/yandex-metrica-watch/tag.js", "ym"); ym(61598311, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/61598311" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
    <!-- Yandex.Metrika counter --> <script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(61610518, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true, trackHash:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/61610518" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162702101-1"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'UA-162702101-1');
    </script>
    <a href="#menu" class="menu-mobile">
        <span></span>
    </a>
    <section class="menu">
        <h2 class="menu_title" hidden>Меню</h2>
        <div class="menu-list">
            <ul>
                    ...
                    <div class="main-text wow zoomInUp">
                        ...
                        <div class="main-text__form">
                            <div class="form-title">
                                ...
                                <span class="form-title__uppertext">
                                    Образцы упаковки бесплатно!
                                </span>
                            </div>
                            <form action="mailer/smart.php" method="POST" class="form main-form">
                                <input class="form__input" type="tel" name="user_phone"
                                    placeholder="Введите номер телефона">
                                <button onclick="ym(61610518, 'reachGoal', 'mainMenuSendPhone'); return true;"
                                    class="button button_big" type="submit">Оставить заявку!</button>
                            </form>
            ...
            <div class="popup-form">
                <form action="mailer/smart.php" method="POST" class="main-form">
                    <div class="popup-form-header">
                        ...
                        <label for="tel" class="popup-form__label">
                            Введите ваш номер телефона:
                        </label>
                        <input id="tel" type="tel" name="user_phone" class="popup-form__input" required>
                        <button onclick="ym(61610518, 'reachGoal', 'mainMenuSendPhone'); return true;" class="button popup-form_btn">
                            Оставить заявку!
                        </button>
    ...
    <section class="features" id="features">
        <h2 class="menu_title" hidden>Фичи</h2>
        <div class="container">
            <!-- СТРОЧНО БЛОЧНЫЙ СПОСОБ-->
            <div class="numbers wow slideInUp">
            ...
            <div class="features-blocks">
                ...
                <div class="features-block wow fadeInUp" data-wow-duration='2s'>
                    ...
                    <div class="features-block__text">
                        ...
                        <!-- /.features-block__title -->
                        <div class="features-block__descr">
                            Возможно нанесение вашего логотипа, текста или манипуляционных знаков
                        </div>
                        <!-- /.features-block__descr -->
                    </div>
                    <!-- /.features-block__text -->
    ...
    <section class="products" id="products">
        <div class="container">
            <h2 class="section-title wow rubberBand">Наша продукция</h2>
            <!-- /.section-title -->
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="products-block">
                        ...
                        <div onclick="ym(61610518, 'reachGoal', 'mainMenuSendPhone'); return true;"
                            class="products-block__buttons"><button
                                class="button button-o products-block__button">Подробнее</button>
                            <button class="button popup__button">Получить расчет</button>
                        </div>
    ...
    <section class="offer dark-bg">
        <div class="container">
            <h2 class="offer-title"> Получите индивидуальное предложение</h2>
            <span class="offer-title_small">на производство и поставку изделий</span>
            <!-- /.offer-title -->
            <div class="offer-form">
                <form action="mailer/smart.php" method="POST" class="main-form">
                    <label class="offer-form__label" for="tel">Введите ваш номер телефона:</label>
                    <input class="form__input offer-form__input" type="tel" name="user_phone"
                        placeholder="+7 (ХХХ) ХХХ-ХХ-ХХ">
                    <button onclick="ym(61610518, 'reachGoal', 'mainMenuSendPhone'); return true;"
                        class="button offer-form__button">Оставить заявку</button>
                </form>
                <small class="form-small">*Минимальный заказ 500шт</small>
            </div>
            <!-- /.offer-form -->
    ...
    <section class="production" id="production">
        <h2 class="menu_title" hidden>Производство</h2>
        <div class="container">
            <div class="row">
                ...
                <!-- /.col-7 -->
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 set2">
                    <div class="production-text">
                        ...
                        <div class="production-text__descr">
                            ...
                            гофрокартона ежемесячно. Гофрокороба и лотки производятся по ГОСТу или чертежам
                            заказчика.<br>
                            <p></p>
                            Досконально прорабатываем конструкции коро- бов и составы сырья, учитывая условия хранения,
                            транспортировки и производства вашей продукции.<br>
                            <p></p>
    ...
    <section class="feedback" id="feedback">
        <div class="container">
            <h1 class="section-title">Отзывы о сотрудничестве</h1>
            <!-- /.section-title -->
    ...
    <section class="contacts" id="contacts">
        <h2 class="menu_title" hidden>Контакты</h2>
        <!-- yandex maps-->
        <!-- <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A6f16c7e67e7be86eb498039025c5d592f7b86dcb9267c354dd7a2dd47e896dba&amp;width=100%25&amp;height=550&amp;lang=ru_RU&amp;scroll=false"></script> -->
        <!-- google maps-->
        <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2306.4285919046038!2d55.79455045118099!3d54.68448518018442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x43d925a0032367eb%3A0xe08a0953635359de!2z0JzQsNC50LrQvtC_0YHQutCw0Y8g0YPQuy4sIDY1LzIsINCj0YTQsCwg0KDQtdGB0L8uINCR0LDRiNC60L7RgNGC0L7RgdGC0LDQvSwgNDUwMDk1!5e0!3m2!1sru!2sru!4v1585662146966!5m2!1sru!2sru" width="100%" height="550" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe> -->
        <!-- 2Gis maps-->
    ...
    <section class="footer">
        <h2 class="menu_title" hidden>Подвал</h2>
    ...
    <!-- создание формы ПРИМЕР
        <form action="mail.php" method="POST">
            <input type="text" name="user_name" placeholder="Введите имя">
            <input type="tel" name="user_phone" placeholder="Введите телефон">
    ...
    <script>
        $(document).ready(function () {
            ...
            navLink.click(function () {
                menuLink.removeClass('menu-mobile_active')
                menu.toggleClass('menu_active')
            });
        });
    </script>
